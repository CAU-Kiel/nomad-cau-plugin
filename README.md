...
```sh
git clone https://github.com/CAU-Kiel/nomad-cau-plugin.git
cd nomad-cau-plugin
...
| Name | E-mail     |
|------|------------|
| Stepanka Lankova | [stepanka.lankova@gmail.com](mailto:stepanka.lankova@gmail.com)
